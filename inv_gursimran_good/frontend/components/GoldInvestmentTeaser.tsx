        ...
        <div className="space-y-10">
          ...
          <div className="grid grid-cols-2 gap-8 pt-4">
            <div className="flex flex-col gap-2">
              <div className="w-10 h-10 rounded-2xl bg-[#B8975A]/10 flex items-center justify-center text-[#5C0828]">
                <TrendingUp size={20} />
              </div>
          ...
          <div className="pt-8">
            <Link 
              ...
              className="inline-flex items-center gap-3 px-8 py-4 bg-[#5C0828] text-white rounded-2xl text-xs font-black uppercase tracking-widest shadow-xl shadow-[#5C0828]/20 hover:-translate-y-1 hover:shadow-2xl transition-all duration-300"
            >
