        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            <FadeIn delay={0}>
              ...
              <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-[#5C0828] mb-8 leading-[1.1]">The Art of Perfection, Located in Punjab</h2>
              <div className="space-y-8">
                <div className="flex gap-6">
                  <div className="w-10 h-10 rounded-full bg-[#5C0828]/5 flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    <h4 className="text-[11px] font-black uppercase tracking-widest text-[#5C0828] mb-2">Flagship Boutique</h4>
                ...
                <div className="flex gap-6">
                  ...
                  <div>
                    <h4 className="text-[11px] font-black uppercase tracking-widest text-[#5C0828] mb-2">Bespoke Experience</h4>
                    <p className="text-sm text-[#7A8C85] leading-relaxed">
