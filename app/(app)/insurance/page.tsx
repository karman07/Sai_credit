  ...
  return (
    <div className="space-y-5 animate-fadeIn">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-xl font-bold tracking-tight">My Insurance Entries</h1>
          <p className="text-sm text-muted mt-0.5">Track insurance policies for your loan cases</p>
        </div>
      ...
      {loading ? (
        ...
        <div className="card">
          <EmptyState
            ...
            description={search ? "Try a different search." : "Add insurance details for your loan cases."}
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-2 mt-6">
            <input
              ...
              className="rounded"
            />
            <label htmlFor="renewal-sales" className="text-sm font-medium">Tag for Renewal</label>
          </div>
